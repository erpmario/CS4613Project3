...
public class Project3 extends JFrame implements GLEventListener, KeyListener
{
	...
	public Project3()
	{
		...
		m_lightLocation = new Point3D(10.0f, 10.0f, 10.0f);
	...
	public void display(GLAutoDrawable drawable)
	{
		...
		//		gl.glUniformMatrix4fv(mvLoc2, 1, false, m_mvStack.peek().getFloatValues(), 0);
		//
		...
		//		/*gl.glBindBuffer(GL_ARRAY_BUFFER, m_vbo[20]);
		...
		//			m_mvStack.pushMatrix();
		//			m_mvStack.translate(m_lightLocation.getX(), m_lightLocation.getY(), m_lightLocation.getZ());
		//
		//			// Pass the model-view matrix to a uniform in the shader.
		//			gl.glUniformMatrix4fv(mvLoc2, 1, false, m_mvStack.peek().getFloatValues(), 0);
		//
		...
		//
		//			// Bind the normal buffer to a vertex attribute.
		//			/*gl.glBindBuffer(GL_ARRAY_BUFFER, m_vbo[26]);
		//			gl.glVertexAttribPointer(2, 3, GL_FLOAT, false, 0, 0);
		//			gl.glEnableVertexAttribArray(2);*/
		//
		//			// Set up texture.
	...
	public void keyPressed(KeyEvent e)
	{
		...
		switch(keyCode)
		{
			...
			case KeyEvent.VK_I:
				...
				//System.out.println(m_lightLocation.toString());
				break;
			case KeyEvent.VK_K:
				m_lightLocation.setZ(m_lightLocation.getZ() + LIGHT_MOVEMENT_FACTOR);
				//System.out.println(m_lightLocation.toString());
